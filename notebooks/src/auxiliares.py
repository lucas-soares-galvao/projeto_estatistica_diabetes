...
def analise_ttest_ind(
    ...
    if valor_p_ttest > alfa:
        print(f"Não rejeita a hpótese nula (valor p: {valor_p_ttest:.3f})")
    else:
...
def analise_anova_one_way(
    ...
    if valor_p_f > alfa:
        print(f"Não rejeita a hpótese nula (valor p: {valor_p_f:.3f})")
    else:
...
def analise_wilcoxon(
    ...
    if valor_p_wilcoxon > alfa:
        print(f"Não rejeita a hpótese nula (valor p: {valor_p_wilcoxon:.3f})")
    else:
